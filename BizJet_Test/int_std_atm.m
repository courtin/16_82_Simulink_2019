...
%
% Usage:    [T, p, rho, a, mu, delta, sigma, theta] = int_std_atm(h)
%
...
function [T, p, rho, a, mu, delta, sigma, theta] = int_std_atm(h_in, flight_condition_in)
if nargin == 1
  flight_condition = 'std day';
else
  flight_condition = flight_condition_in;
end
