...
dE      =	-4;      % Elevator angle, deg
dR      =	0;      % Rudder angle, deg
dF_L    =   40;     % Flap angle, deg
dF_R    =   40;     % Flap angle, deg
dB_L    = 	.9;    % Left Blower throttle setting, % / 100
dB_R    = 	.9;    % Right Blower throttle setting, % / 100
...
[CX,CL,CY,Cl,Cm,Cn]	=	AeroModelSSTOL_VL(x,u,Mach,alphar,betar,V)
